              ...
              <form @submit.prevent="handleSubmit" id="account_info_form">
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    value="Dhoe"
                    :class="{ 'is-invalid': submitted && $v.user.lname.$error }"
                  />
                  <div
                ...
                <button class="theme-btn-one bg-black btn_sm">
                  Update Information
                </button>
              </form>
            </div>
      ...
      meta: [
        {
          ...
          name: "description",
          content:
            "Account info edit page - AndShop Ecommerce Vue js, Nuxt js Template",
        },
      ],
    };
  },
