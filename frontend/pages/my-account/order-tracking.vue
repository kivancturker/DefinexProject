              ...
              <form @submit.prevent="handleOrderSubmit">
                <div class="form-group">
                  ...
                  <input
                    ...
                    :class="{
                      'is-invalid': submitted && $v.order.order_id.$error,
                    }"
                  />
                  <div
                    v-if="submitted && !$v.order.order_id.required"
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    :class="{
                      'is-invalid': submitted && $v.order.email.$error,
                    }"
                  />
                  <div
                    v-if="submitted && $v.order.email.$error"
                    class="invalid-feedback"
                  >
                    <span v-if="!$v.order.email.required"
                      >Billing Email is required</span
                    >
                    <span v-if="!$v.order.email.email"
                      >Billing Email is invalid</span
                    >
                  </div>
                </div>
      ...
      meta: [
        {
          ...
          name: "description",
          content:
            "Order Tracking page - AndShop Ecommerce Vue js, Nuxt js Template",
        },
      ],
    };
  },
