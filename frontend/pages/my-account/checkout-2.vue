              ...
              <div class="user-actions">
                <h3 role="tab">
                  ...
                  <b-button
                    ...
                    v-b-toggle.checkout_login
                    >Click here to login</b-button
                  >
                </h3>
                <b-collapse
                  id="checkout_login"
                    ...
                    <form @submit.prevent="handleLoginSubmit">
                      <div class="form_group default-form-box">
                        ...
                        <input
                          ...
                          :class="{
                            'is-invalid':
                              submitted && $v.userLogin.username.$error,
                          }"
                        />
                        <div
                          v-if="submitted && !$v.userLogin.username.required"
                      ...
                      <div class="form_group default-form-box">
                        ...
                        >
                          ...
                          >
                          <span v-if="!$v.userLogin.password.minLength"
                      ...
                      <div class="row pt-4">
                        ...
                        <div class="col-12">
                          <div class="default-form-box">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid':
                                  submitted && $v.user.companyname.$error,
                              }"
                            />
                            <div
                              v-if="submitted && !$v.user.companyname.required"
                              class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                          <div class="default-form-box">
                            ...
                            <select
                              class="country_option nice-select wide form-control"
                        ...
                        <div class="col-12">
                          <div class="default-form-box">
                            ...
                            <input
                              ...
                              :class="{
                                'is-invalid':
                                  submitted && $v.user.street.$error,
                              }"
                            />
                            <div
                              v-if="submitted && !$v.user.street.required"
                              class="invalid-feedback"
                            >
                              Street is required
                            </div>
                    ...
                    <div class="payment_method">
                      <div class="payment-inner panel-default">
                        <b-button class="bg-transparent p-0 border-0">
                          ...
                          <label for="currencyCod" v-b-toggle.methodCod></label>
                          Cash on Delivery
                        </b-button>
