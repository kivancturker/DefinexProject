            ...
            <div class="table_desc">
              <div class="table_page table-responsive compare-table mb-0">
                <table class="table">
                  <tbody v-if="compare.length">
                    <tr>
                      ...
                      >
                        ...
                        <nuxt-link to="/shop/shop-4" class="category">{{
                          item.type
                        }}</nuxt-link>
                        <h5>
                          <nuxt-link
                    ...
                    <tr>
                      ...
                      <td
                        v-for="(item, index) in compare"
                        :key="index"
                        class="pro-remove product_remove"
                      >
                        <button
                  ...
                  <tbody v-else>
                    <tr>
                      <td>No item found to compare!</td>
                    </tr>
                  </tbody>
                </table>
              </div>
